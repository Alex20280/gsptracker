...
object WorkManagerModule {
    ...
    @Provides
    fun provideLocationTrackerUseCase(fusedLocationClient: FusedLocationProviderClient): LocationTrackingRepositoryImpl {
        return LocationTrackingRepositoryImpl(fusedLocationClient)
    }
}